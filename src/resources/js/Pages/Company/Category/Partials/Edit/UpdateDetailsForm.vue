<template>
  <t-form-section @submitted="update">
    <template #title>Basic Information</template>

    <template #description>Update company category's information.</template>
...
export default defineComponent({
  ...
  methods: {
    update() {
      this.form.put(
        route('company.category.update', { category: this.category.id }),
        {
          preserveScroll: true
        }
      )
