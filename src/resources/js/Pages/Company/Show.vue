  ...
  <app-layout title="Company List">
    ...
    <template #flash-banner>
      <banner
        ...
        message="This company is not verified, therefore you cannot claim interhsip."
        type="warning"
      />
    </template>
            ...
            <div class="rounded-lg bg-white overflow-hidden shadow">
              ...
              >
                <div class="px-6 py-5 text-sm font-medium text-center">
                  <span class="text-gray-900 pr-1">12</span>
                  <!-- space -->
                  <span class="text-gray-600">Interships are completed</span>
                </div>

                <div class="px-6 py-5 text-sm font-medium text-center">
                  <span class="text-gray-900 pr-1">4</span>
                  <!-- space -->
                  <span class="text-gray-600">Interships are claimed</span>
                </div>
              ...
              >
                <div>
                  ...
                  >
                    <svg
                      class="h-6 w-6"
                      x-description="Heroicon name: outline/cash"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
              ...
              >
                <div>
                  ...
                  >
                    <svg
                      class="h-6 w-6"
                      x-description="Heroicon name: outline/receipt-refund"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
              ...
              >
                <div>
                  ...
                  >
                    <svg
                      class="h-6 w-6"
                      x-description="Heroicon name: outline/academic-cap"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
...
import CompanyInformation from '@/Pages/Company/Partials/CompanyInformation'
import Banner from '@/Components/Utils/Banner'
import ActivityTimeline from '@/Pages/Company/Partials/Show/ActivityTimeline'
import Header from '@/Pages/Company/Partials/Header'
import HeaderActions from '@/Pages/Company/Partials/HeaderActions'
