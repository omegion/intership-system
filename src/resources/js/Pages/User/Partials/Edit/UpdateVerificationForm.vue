<template>
  <t-form-section @submitted="updateUserVerificationInformation">
    <template #title>Verification Information</template>

    <template #description>
      Update user's verification information. You can change the verification
      information.
    </template>
...
export default defineComponent({
  ...
  methods: {
    updateUserVerificationInformation() {
      this.form.post(route('user.updateVerification', { user: this.user.id }), {
        errorBag: 'updateUserVerificationInformation',
        preserveScroll: true
      })
    }
  },
